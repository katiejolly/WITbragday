...
```{r}
sentiments <- sentiment(wit_bragday$text)

table(sentiments$polarity)

ggplot(sentiments, aes(x = polarity)) + geom_bar(fill = "#490ca9") + theme_hc() +  theme(axis.text.x = element_text(angle = 60, 
                                   hjust = 1, 
                                   vjust = 1, 
                                   color ="#565656"),
        plot.title = element_text(face = "bold", 
        ...
        plot.subtitle = element_text(face = "italic", 
                                     color = "#565656"),
        axis.title = element_text(color = "#444444"),
        plot.caption = element_text(color = "#8e8e8e")) + labs(x = "polarity", y = "count")
ggsave("polarity.png")
```
